...
public class AddNewTask  extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mDeptEdit = view.findViewById(R.id.dept_edittext);
        mLocationEdit = view.findViewById(R.id.location_edittext);
        ...
        if (bundle != null){
            ...
            mLocationEdit.setText(task);
            mDeptEdit.setText(task);
        ...
        mSaveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String dept = mDeptEdit.getText().toString();
                ...
                if (finalIsUpdate){
                    ...
                    if (task.isEmpty()) {
                        ...
                        taskMap.put("dept", dept);
                        taskMap.put("start", startDate);
